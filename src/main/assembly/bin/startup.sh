...
nohup java -Xms512m -Xmx512m -Xss256K -server -Djava.awt.headless=true -Dfile.encoding=utf-8 $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS $CONFIG_FILES -jar $DEPLOY_DIR/lib/$JAR_NAME >> $STDOUT_FILE 2>&1 &
